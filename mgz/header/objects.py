...
unit = "unit"/Struct(
    ...
    "end_of_unit"/Find(b'\xff\xff\xff\xff\x00\x00\x80\xbf\x00\x00\x80\xbf\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\x00\x00\x00\x00\x00\x00', None)
)
...
building = "building"/Struct(
    ...
    If(lambda ctx: ctx.num < 100,
        Array(lambda ctx: ctx.num, "id2"/Int32ul),
    ),
    Padding(93),
)
