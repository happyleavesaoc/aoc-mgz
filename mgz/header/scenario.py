...
messages = "messages"/Struct(
    ...
    "history_id"/Int32ul,
    "scouts_id"/Int32ul,
    "instructions"/PascalString(lengthfield = "instructions_length"/Int16ul, encoding='latin1'), # this contains the map name
...
game_settings = "game_settings"/Struct(
    ...
    Padding(4),
    Array(9, "player_info"/Struct("data_ref"/Int32ul, PlayerTypeEnum("type"/Int32ul), "name"/PascalString( lengthfield = "name_length"/Int32ul))),
    Padding(36),
    Padding(4),
